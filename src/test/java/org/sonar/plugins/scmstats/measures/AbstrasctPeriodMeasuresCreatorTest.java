...
public abstract class AbstrasctPeriodMeasuresCreatorTest {

  protected abstract AbstractPeriodMeasuresCreator getCreator();
  ...
  public void shouldGetCommitsPerUserMeasure(){
    ...
    final CommitsPerUserMeasure measure = getCreator().getCommitsPerUserMeasure(map);
  ...
  public void shouldGetCommitsPerClockHourMeasure(){
    ...
    AbstractScmStatsMeasure measure = getCreator().getCommitsPerClockHourMeasure(initMap());
  ...
  public void shouldGetCommitsPerMOnthMeasure(){
    ...
    AbstractScmStatsMeasure measure = getCreator().getCommitsPerMonthMeasure(initMap());
    assertMeasure(measure, CommitsPerMonthMeasure.class,14);
  }
  @Test
  public void shouldGetCommitsPerWeekDayMeasure(){
    
    AbstractScmStatsMeasure measure = getCreator().getCommitsPerWeekDayMeasure(initMap());
  ...
  protected void assertMeasure(AbstractScmStatsMeasure measure, Class instance, int mapSize) {
